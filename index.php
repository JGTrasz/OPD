...
// ichecheck kung yung form ay nasumbit
...
<head>
    ...
    <title>United Doctors of St. Camillus de Lellis Hospital and Medical Center </title>
...
<body>
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    ...
                    <img src="assets/images/logo.jpg" alt="Logo" style="max-width: 50%;">
            ...
            <div class="carousel-inner">
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">United Doctors of St. Camillus de Lellis Hospital and Medical Center </h5>
                    </div>
                </div>
    ...
    <section id="about_us" class="about-us">
        <div class="row no-margin">
            ...
            <div class="col-sm-6 abut-yoiu">
                ...
                <?php
                // dito kukunin yung sa about us ng St.Camillus
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 map-img">
                    ...
                    <address class="md-margin-bottom-40">
                        <?php
                        // ito yung nagcocollect ng info ng contact 
    ...
    <div class="copy">
        <div class="container">
        United Doctors of St. Camillus de Lellis Hospital and Medical Center 
        </div>
    </div>
